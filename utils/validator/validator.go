...
var ValidateEntry *validator.Validate

func init() {
	ValidateEntry = validator.New()
	InitValidatorDefault("en")
}

func InitValidatorDefault(locale string) (err error) {
	return InitValidator(locale, ValidateEntry)
}
...
func InitValidator(locale string, v *validator.Validate) (err error) {
